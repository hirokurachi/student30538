...
```{python}
dense = dissolved[dissolved["dense"]==1]
geo = dense.buffer(500)

austin = dissolved.plot(facecolor="grey")

dense_zone = geo.plot(ax=austin, alpha=0.5)
dense_zone.set_axis_off()
```
<!-- 
