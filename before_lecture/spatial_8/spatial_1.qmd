...
MEMO: different from WKT, this is easier to understand for computers.
...
exterior = [(-3, 0), (3, 0), (0, 4)]

tri = Polygon(shell = exterior)
tri

square = Polygon([(1, 0), (-1, 0), (-1, 1), (1, 1)])
square
...
1.  Create a triangle
```{python}
exterior_tri = [(-60,0), (60, 0), (0, 80)]
poly_tri = Polygon(shell = exterior_tri)
...
2.  Create a square
```{python}
exterior_sq = [(-60,0), (0, -60), (60, 0), (0, 60)]
poly_sq = Polygon(shell = exterior_sq)
...
poly_sq_buffer = poly_sq.buffer(10)
